...
class SubprocessVisitor(ast.NodeVisitor):
    ...
    def visit_Call(self, node):
        ...
        if (is_os_system or is_os_popen) and node.args:
            ...
            is_dynamic = self._is_dynamic_string(first_arg) or (
                isinstance(first_arg, ast.Name) and first_arg.id in self.dynamic_vars
            )
        ...
        if is_subprocess:
            ...
            if shell_true and node.args:
                ...
                is_dynamic = self._is_dynamic_string(first_arg) or (
                    ...
                    and first_arg.id in self.dynamic_vars
                )
